package jdatabase;
	...
	{  
		...
		static String databasepassword = "systemck";
		...
		*/
		...
		public static void initializedatabase(int databaseID)
		{
			...
			try
			{
				String dbConfigFileName = "G:\\csk\\dbconfig_customer.json";
				
				if (databaseID == 0)
					dbConfigFileName = "G:\\csk\\dbconfig_customer.json";
				else if (databaseID == 1)
					dbConfigFileName = "G:\\csk\\dbconfig_account.json";
				else if (databaseID == 2)
					dbConfigFileName = "G:\\csk\\dbconfig_moneytransfer.json";
				else if (databaseID == 3)
					dbConfigFileName = "G:\\csk\\dbconfig_eventsync.json";
